...
def render_human_report(result: dict) -> str:
    ...
    try:
        ...
        lines.append("")
        lines.append("*Generated by grok-coding-delegate — review the actual code changes in the working directory for the definitive end result.*")
...
def main():
    ...
    parser.add_argument("--version", action="version", version=f"grok-coding-delegate {_VERSION}")
